...
(  
	AUDITORIUM_TYPE  char(10) constraint 
	AUDITORIUM_TYPE_PK  primary key,  
...
(  
	FACULTY char(10)   constraint
	FACULTY_PK primary key,
...
------Создание и заполнение таблицы PROFESSION
  ...
  (  
	PROFESSION char(20) constraint
	PROFESSION_PK primary key,
...
(
AUDITORIUM char(20)  constraint
AUDITORIUM_PK primary key,              
...
------Создание и заполнение таблицы PULPIT
  create table  PULPIT 
(
PULPIT      char(20)  constraint
PULPIT_PK  primary key,
...
------Создание и заполнение таблицы TEACHER
 ...
 (
 TEACHER char(10)  constraint
 TEACHER_PK  primary key,
